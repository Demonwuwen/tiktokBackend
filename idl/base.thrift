...
service BaseApiService{
    ...
    UserResponse UserGet(1: UserRequest req) (api.post="/douyin/user")
    PublishActionResponse PublishVideo(1: PublishActionRequest req) (api.get="/douyin/publish/action")
    PublishListResponse PublishList(1: PublishListRequest req) (api.put="/douyin/publish/list")
    FeedResponse DeleteNote(1: FeedRequest req) (api.delete="/douyin/feed")
}