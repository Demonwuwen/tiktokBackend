...
func NewServiceInfo() *kitex.ServiceInfo {
	...
	methods := map[string]kitex.MethodInfo{
		...
		"UserGet":      kitex.NewMethodInfo(userGetHandler, newUserServiceUserGetArgs, newUserServiceUserGetResult, false),
	}
...
func userGetHandler(ctx context.Context, handler interface{}, arg, result interface{}) error {
	realArg := arg.(*user.UserServiceUserGetArgs)
	realResult := result.(*user.UserServiceUserGetResult)
	success, err := handler.(user.UserService).UserGet(ctx, realArg.Req)
	if err != nil {
		return err
	}
	realResult.Success = success
...
func newUserServiceUserGetArgs() interface{} {
	return user.NewUserServiceUserGetArgs()
}

func newUserServiceUserGetResult() interface{} {
	return user.NewUserServiceUserGetResult()
}
...
func (p *kClient) UserGet(ctx context.Context, req *user.UserRequest) (r *user.UserResponse, err error) {
	var _args user.UserServiceUserGetArgs
	_args.Req = req
	var _result user.UserServiceUserGetResult
