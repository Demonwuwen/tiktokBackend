...
func (p *UserServiceClient) UserGet(ctx context.Context, req *UserRequest) (r *UserResponse, err error) {
	var _args UserServiceUserGetArgs
	_args.Req = req
	var _result UserServiceUserGetResult
...
func NewUserServiceProcessor(handler UserService) *UserServiceProcessor {
	...
	self.AddToProcessorMap("UserGet", &userServiceProcessorUserGet{handler: handler})
	return self
}
...
type userServiceProcessorUserGet struct {
	handler UserService
}

func (p *userServiceProcessorUserGet) Process(ctx context.Context, seqId int32, iprot, oprot thrift.TProtocol) (success bool, err thrift.TException) {
	args := UserServiceUserGetArgs{}
	if err = args.Read(iprot); err != nil {
		iprot.ReadMessageEnd()
		x := thrift.NewTApplicationException(thrift.PROTOCOL_ERROR, err.Error())
	...
	iprot.ReadMessageEnd()
	var err2 error
	result := UserServiceUserGetResult{}
...
type UserServiceUserGetArgs struct {
	Req *UserRequest `thrift:"req,1" frugal:"1,default,UserRequest" json:"req"`
}

func NewUserServiceUserGetArgs() *UserServiceUserGetArgs {
	return &UserServiceUserGetArgs{}
}

func (p *UserServiceUserGetArgs) InitDefault() {
	*p = UserServiceUserGetArgs{}
}

var UserServiceUserGetArgs_Req_DEFAULT *UserRequest

func (p *UserServiceUserGetArgs) GetReq() (v *UserRequest) {
	if !p.IsSetReq() {
		return UserServiceUserGetArgs_Req_DEFAULT
	}
	return p.Req
}
func (p *UserServiceUserGetArgs) SetReq(val *UserRequest) {
	p.Req = val
}

var fieldIDToName_UserServiceUserGetArgs = map[int16]string{
	1: "req",
}

func (p *UserServiceUserGetArgs) IsSetReq() bool {
	return p.Req != nil
}

func (p *UserServiceUserGetArgs) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceUserGetArgs[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceUserGetArgs) ReadField1(iprot thrift.TProtocol) error {
...
func (p *UserServiceUserGetArgs) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *UserServiceUserGetArgs) writeField1(oprot thrift.TProtocol) (err error) {
	if err = oprot.WriteFieldBegin("req", thrift.STRUCT, 1); err != nil {
		goto WriteFieldBeginError
	}
	if err := p.Req.Write(oprot); err != nil {
...
func (p *UserServiceUserGetArgs) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceUserGetArgs(%+v)", *p)
}

func (p *UserServiceUserGetArgs) DeepEqual(ano *UserServiceUserGetArgs) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *UserServiceUserGetArgs) Field1DeepEqual(src *UserRequest) bool {
...
type UserServiceUserGetResult struct {
	Success *UserResponse `thrift:"success,0,optional" frugal:"0,optional,UserResponse" json:"success,omitempty"`
}

func NewUserServiceUserGetResult() *UserServiceUserGetResult {
	return &UserServiceUserGetResult{}
}

func (p *UserServiceUserGetResult) InitDefault() {
	*p = UserServiceUserGetResult{}
}

var UserServiceUserGetResult_Success_DEFAULT *UserResponse

func (p *UserServiceUserGetResult) GetSuccess() (v *UserResponse) {
	if !p.IsSetSuccess() {
		return UserServiceUserGetResult_Success_DEFAULT
	}
	return p.Success
}
func (p *UserServiceUserGetResult) SetSuccess(x interface{}) {
	p.Success = x.(*UserResponse)
}

var fieldIDToName_UserServiceUserGetResult = map[int16]string{
	0: "success",
}

func (p *UserServiceUserGetResult) IsSetSuccess() bool {
	return p.Success != nil
}

func (p *UserServiceUserGetResult) Read(iprot thrift.TProtocol) (err error) {
...
ReadFieldBeginError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d begin error: ", p, fieldId), err)
ReadFieldError:
	return thrift.PrependError(fmt.Sprintf("%T read field %d '%s' error: ", p, fieldId, fieldIDToName_UserServiceUserGetResult[fieldId]), err)
SkipFieldError:
	return thrift.PrependError(fmt.Sprintf("%T field %d skip type %d error: ", p, fieldId, fieldTypeId), err)
...
func (p *UserServiceUserGetResult) ReadField0(iprot thrift.TProtocol) error {
...
func (p *UserServiceUserGetResult) Write(oprot thrift.TProtocol) (err error) {
	var fieldId int16
...
func (p *UserServiceUserGetResult) writeField0(oprot thrift.TProtocol) (err error) {
	if p.IsSetSuccess() {
		if err = oprot.WriteFieldBegin("success", thrift.STRUCT, 0); err != nil {
			goto WriteFieldBeginError
		}
...
func (p *UserServiceUserGetResult) String() string {
	if p == nil {
		return "<nil>"
	}
	return fmt.Sprintf("UserServiceUserGetResult(%+v)", *p)
}

func (p *UserServiceUserGetResult) DeepEqual(ano *UserServiceUserGetResult) bool {
	if p == ano {
		return true
	} else if p == nil || ano == nil {
		return false
...
func (p *UserServiceUserGetResult) Field0DeepEqual(src *UserResponse) bool {
