// The License
//
// Copyright (c) 2023 Demonwuwen
//copy it from hertz jwt
...
func InitJWT() {
	JwtMiddleware, _ = New(&HertzJWTMiddleware{
		...
		Authenticator: func(ctx context.Context, c *app.RequestContext) (interface{}, error) {
			...
			return rpc.UserLogin(ctx, &user.UserLoginRequest{
				Username: req.Username,
				Password: req.Password,
			})
		},
		LoginResponse: func(ctx context.Context, c *app.RequestContext, code int64, token string, time time.Time) {
...
type HertzJWTMiddleware struct {
	...
	//This is my own LoginResponse
	LoginResponse func(ctx context.Context, c *app.RequestContext, userId int64, message string, time time.Time)
...
func (mw *HertzJWTMiddleware) MiddlewareInit() error {
	...
	if mw.LoginResponse == nil {
		mw.LoginResponse = func(ctx context.Context, c *app.RequestContext, usrId int64, token string, expire time.Time) {
...
func (mw *HertzJWTMiddleware) LoginHandler(ctx context.Context, c *app.RequestContext) {
	...
	mw.LoginResponse(ctx, c, data.(int64), tokenString, expire)
}
